...
.mentor-info-profile-edit-button{display:flex;align-items:center;justify-content:center;width:100%;min-height:72rpx;margin:0;padding:0;border:2rpx solid #bcd4fb;border-radius:18rpx;background:#f7faff;color:#3977df;font-size:22rpx;line-height:1.25;font-weight:850;box-sizing:border-box}
...
.mentor-info-edit-mode-notice button{min-width:78rpx;min-height:50rpx;margin:0;padding:0 14rpx;border:0;border-radius:15rpx;background:#fff;color:#b26a73;font-size:19rpx;font-weight:850;box-shadow:0 5rpx 14rpx rgba(180,106,115,.09);flex-shrink:0}
...
.mentor-info-skill-options button{min-height:48rpx;margin:0;padding:0 14rpx;border:2rpx solid #f0d3d5;border-radius:14rpx;background:#fff;color:#8b737a;font-size:19rpx;font-weight:750}
